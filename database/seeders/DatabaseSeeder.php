...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($categorias as [$id, $nombre]) {
            Categoria::updateOrCreate(compact('id'), compact('nombre'));
        }
        ...
        foreach ($subcategorias as [$id, $nombre, $categoria_id]) {
            Subcategoria::updateOrCreate(compact('id'), compact('nombre', 'categoria_id'));
        }
        ...
        foreach ($movimientos as [$id, $fecha, $tipo, $monto, $categoria_id, $subcategoria_id, $meta_ahorro_id]) {
            Movimiento::updateOrCreate(compact('id'), [
